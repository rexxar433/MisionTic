...
public class VistaRequerimientosReto4 extends JFrame {
    ...
    public VistaRequerimientosReto4() {
        ...
        JButton btnConsuta2 = new JButton("Requerimiento 3");
        ...
        btnConsuta2.setBounds(294, 537, 133, 29);
        contentPane.add(btnConsuta2);

        JButton btnConsuta3 = new JButton("Requerimiento 2");
        ...
        btnConsuta3.setBounds(157, 537, 133, 29);
    ...
    public void requerimiento3() {
        try {
            ArrayList<ProyectosCasaCampestre> rankingProyectosCasaCampestre = controlador
